...
<head>
    ...
    <title>Kategori Yönetimi - A101 Stok Sistemi</title>
    ...
    <div class="container mt-4">
        <div class="row mb-4">
            <div class="col-12">
                ...
                <p class="text-muted">Ürün kategorilerini hiyerarşik olarak yönetin</p>
            </div>
        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-2">
                                <a href="/products" class="btn btn-info w-100">
                                    <i class="bi bi-box"></i> Ürünler
                                </a>
                            </div>
                            <div class="col-md-3 mb-2">
                                <a href="/stocks" class="btn btn-warning w-100">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h6 class="mb-0">
                            <i class="bi bi-list"></i> Kategori Listesi
                        </h6>
                    </div>
                    <div class="card-body">
                        @if($categories->count() > 0)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if($category->children_count > 0)
                                                        <span class="badge bg-warning">{{ $category->children_count }} alt kategori</span>
                                                    @else
                                                        <span class="badge bg-light text-dark">Alt kategori yok</span>
                                                    @endif
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <div class="btn-group" role="group">
                                                        ...
                                                        <a href="{{ route('categories.products', $category) }}" class="btn btn-sm btn-outline-info">
                                                            <i class="bi bi-box"></i>
                                                        </a>
                                                    </div>
                                                </td>
                            ...
                            <!-- Pagination yok - tüm kategoriler tek sayfada gösteriliyor -->
                        @else
                            <div class="text-center py-5">
                                <i class="bi bi-tags display-1 text-muted"></i>
                                <h4 class="mt-3">Henüz kategori bulunmuyor</h4>
                                <p class="text-muted">İlk kategoriyi oluşturmak için aşağıdaki butona tıklayın.</p>
                                <a href="{{ route('categories.create') }}" class="btn btn-primary">
                                    <i class="bi bi-plus-circle"></i> İlk Kategoriyi Oluştur
                                </a>
                            </div>
                        @endif
                    </div>
